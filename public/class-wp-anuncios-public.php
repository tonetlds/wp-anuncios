...
class Wp_Anuncios_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp-anuncios-public.css', array(), $this->version, 'all' );
